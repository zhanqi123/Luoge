<template>
          ...
          <el-form-item v-for="(item, index) in fromList" :key="item.文件编号" :label="item.文件名称" :required="item.是否必填"
            ...
            <el-row>
              ...
              <el-col :span="5" style="margin-left: 5px;">
                <el-date-picker v-model="binaryDataArray[item.dateModel]" size="mini" value-format="yyyy-MM-dd"
                  type="date" placeholder="签署日期" @change="handleDateChange(item, index)"></el-date-picker>
              </el-col>
  ...
  import { initList, submitData } from '@/api/oneRegister/index.js'
    ...
    methods: {
      initFileLists() {
        ...
        let data = {
          ...
          uuid:'TUpcPHcqvAlGsx3L0Pn+aHH1jHb7+3CGw/mkQjz32hGW9dSJbeR4JWieFu3I/oWkSoW+Qdqo6yVB0oyKhp0hwyiMDUGURYzQ'
        }
