<template>
    <div class="project-container">
            ...
            <div class="search-area">
                ...
                <el-form :inline="true" :model="searchForm" class="demo-form-inline">
                    <el-form-item label="项目信息">
                        <el-input style="width: 350px;" v-model="searchForm.ProjectID"
                            placeholder="请输入项目关键词"></el-input>
                    </el-form-item>
        ...
        <el-table :data="tableData" style="width: 100%" border stripe @selection-change="handleSelectionChange"
            ...
            <el-table-column label="操作" width="180" align="center" fixed="right">
                <template slot-scope="scope">
                    ...
                    <div v-if="!scope.row.测评组长">
                        <el-button size="mini" type="primary" icon="el-icon-user-solid"
                            @click="handleBelong(scope.row)">设置测评组长</el-button>
                    </div>
                    <div v-else>
                        <el-tag type="primary" effect="plain" style="cursor: pointer;"
                            @click="handleBelong(scope.row)">已分配</el-tag>
                    </div>
        ...
        <el-dialog title="待分配人员" :visible.sync="staffDialogVisible" width="70%" append-to-body>
            ...
            <el-table :data="filteredLeftList" style="width: 100%" border stripe v-loading="staffLoading" height="500">
                ...
                <el-table-column prop="员工级别" label="员工级别" align="center" min-width="120">
                </el-table-column>
            </el-table>
...
export default {
    ...
    created() {
        ...
        if (localStorage.getItem('name')) {
            ...
            // this.searchForm.EvaluationStaffName = '梁烨'
